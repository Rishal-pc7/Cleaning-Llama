...
function Navbar() {
  return (
    <div className="z-20 text-white right-1/2 translate-x-1/2 min-w-[70%] md:min-w-[35%] h-10 md:h-10  backdrop-blur-lg bg-white/5 border border-white/30 rounded-xl shadow-lg absolute top-4 flex justify-between">
      <MobNav/>
