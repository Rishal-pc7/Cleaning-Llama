  ...
  return (
    <>
      <div className="relative h-[90vh] w-full flex pb-20 md:pb-0 items-end-safe md:items-center text-white">      
        <Image src={heroImg} placeholder="blur"  alt="Clean modern interior" className="absolute inset-0 object-cover  object-[63%] w-full h-full z-0"  fill  loading='lazy' unoptimized  sizes="(max-width: 640px) 100vw, (max-width: 1024px) 100vw, 100vw"/>
        <div className="absolute inset-0 bg-black/30  z-10"></div>
        <div className="content md:p-5 p-3 z-10 flex flex-col gap-3 md:gap-5">
