...
import { Clock, Handshake, ShieldCheck, Sparkles, Users } from 'lucide-react'
...
export function OurVisionandMission(){
    return (
        ...
        <div className='md:h-[50vh] w-full flex flex-col gap-3 order-2 md:order-1'>
        ...
        <div className='md:h-[50vh] w-full relative order-1 md:order-2'>
