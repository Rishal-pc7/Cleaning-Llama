...
function page() {
  return (
    ...
    <div className='relative grid md:grid-cols-2 md:grid-rows-none grid-rows-2 w-full h-auto md:h-[90vh]  bg-[#24B3DA]/45 pt-28 md:pt-16 pb-0'>
      <div className="flex flex-col justify-center gap-5 basis-1/2 h-full px-8 md:px-16">
      ...
      <div className="flex justify-center min-h-[300px] relative">
        <Image src='/about.png' alt="About Us" className='relative object-cover z-10 w-full h-full' fill  priority />
      </div>
    </div>
    <OurStory/>
    <OurVisionandMission/>
